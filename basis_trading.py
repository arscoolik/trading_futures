...
def init_argparse():
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="price precision")  # DEFAULT% BITCOIN
    parser.add_argument(
        '--slippage',
        type=float,
        default=0.00025,
        help="proportion of coin price")
    parser.add_argument(
        '--multiplier',
        type=dict,
        default=multiplier,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0,
        help="maker: 0.01%, taker: 0.05%")
    parser.add_argument('--max_trial', type=int, default=5,
                        help="number of trials for connection")
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="futures_leverage")
    parser.add_argument(
        '--debug_enabled',
        type=bool,
        default=False,
        help="debug mode is enabled")
    return parser
...
if __name__ == '__main__':
    ...
    position_parser.add_argument(
        ...
        type=int,
        default=20,
        help="spot trading amount for one iteration")
    position_parser.add_argument(
        '--num_maximum',
        type=int,
        default=3,
        help="maximum execution numbers")
    position_parser.add_argument(
        '-f',
        '--threshold',
        type=float,
        default=0.01,
        help="opening threshold")
    position_parser.add_argument(
        '--negative_threshold',
        type=float,
        default=-0.05,
    ...
    position_parser.add_argument(
        ...
        type=int,
        default=5,
        help="number of success required iterations"
    )
